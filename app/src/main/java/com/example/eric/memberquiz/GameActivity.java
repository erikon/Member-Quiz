...
public class GameActivity extends AppCompatActivity {
    ...
    public void loadGame(){
        ...
        int rand_name1 = rand.nextInt(members.length);
        while (rand_name1 == rand_img_num){
            rand_name1 = rand.nextInt(members.length);
        }
        wrong_name1 = image_names.get(rand_name1);

        int rand_name2 = rand.nextInt(members.length);
        while (rand_name2 == rand_img_num || rand_name2 == rand_name1){
            rand_name2 = rand.nextInt(members.length);
        }
        wrong_name2 = image_names.get(rand_name2);

        int rand_name3 = rand.nextInt(members.length);
        while (rand_name3 == rand_img_num || rand_name3 == rand_name1 || rand_name3 == rand_name2){
            rand_name3 = rand.nextInt(members.length);
        }
        wrong_name3 = image_names.get(rand_name3);
    ...
    public void getRandImage(){
        // Get random image
        rand = new Random();
        rand_img_num = rand.nextInt(members.length);
        rand_img = image_names.get(rand_img_num);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(ContactsContract.Intents.Insert.NAME, rand_img);
                timer.cancel();
                if (timer2 != null){
                    timer2.cancel();
                }
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!buttonText.equalsIgnoreCase(rand_img)){
